...
\begin{itemize}
	...
	\item Uninterrupted Focus Timer: Measures duration of continuous attention during stillness sessions. Provides users with visual feedback to reinforce habit formation. Data collected supports the research goal of assessing how technology impacts attention.
	\item Minimalist Interface: A clean, distraction-free UI that minimizes cognitive load. Reduces temptation to engage with other apps during stillness periods, aligning with the goal of promoting attentiveness.
	\item Reflection Prompts: Brief, optional prompts appear after sessions to encourage users to reflect on their experience. Prompts can be customized or general.
	\item Session Analytics Dashboard: Provides users with insights into their patterns concerning session length, frequency, and interruptions. Supports analysis of how consistent quiet time affects attentiveness over time.
	\item Customizable Stillness Modes: Users can choose different modes that tailor the app's behavior during quiet periods. Each can have unique settings for notification blocking and session tracking.
	\item Device Acitivity Logging: Tracks phone pickups or app usage during stillness windows to measure real world distractions. Provides objective metrics to complement the self reported reflection prompts.
	\item Journaling Feature: Optional feature where users can log thoughts or reflections after stillness sessions. Supports qualitative data collection.
	\item End of week Summary Report: Provides users with a broader summary of their habits over a week period. Highlights improvements in attentiveness and consistency.
\end{itemize}

\section*{Stretch Goals}
\begin{itemize}
	\item Social Sharing: Allow users to share their progress or reflections with a community. Encourages accountability and communal growth. Would not make it the main focus of the app, to keep it minimalistic and focused on personal spiritual growth.
	\item Longer Use Logging: Extend the study duration to several months to assess long term changes in attentiveness and spiritual practices.
	\item Sabbath Mode: A special mode for longer duration periods of disconnection, like a few hours or a full day or more.
\end{itemize}
